        ...
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-[13px] text-slate-400 mt-1 font-medium">
              Theo dõi tiến độ khắc phục vi phạm của các cơ sở kinh doanh tại Đà Nẵng
            </p>
          </div>
                ...
                filtered.map((v) => {
                  ...
                  return (
                    <tr key={v.id} className="hover:bg-violet-50/30 transition-colors group">
                      ...
                      <td className="px-5 py-3.5">
                        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold border ${sev.bg} ${sev.text} ${sev.border}`}>
