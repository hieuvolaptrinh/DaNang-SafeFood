...
('CS004', 'Cơ sở nước uống Sơn Trà',      'GP-2024-004', 'CS004', '2026-08-31', 'Hoat dong', 'DANG_HOAT_DONG',     'ND006',
 'https://res.cloudinary.com/dt7ekojue/image/upload/v1778601100/bien-quang-cao-quan-an-sang-1_qnxymu.jpg', 'PX004'),
('CS005', 'Lò bánh mỳ Ngũ Hành Sơn',      'GP-2024-005', 'CS005', '2026-11-30', 'Hoat dong', 'THIEU_HO_SO',        'ND006',
 'https://res.cloudinary.com/dt7ekojue/image/upload/v1778601101/2-bien-quang-cao-quan-an-sang-co-day-du-thong-tin-ve-mon-an-va-ten-quan_lldjkh.jpg', 'PX005');
...
-- [15] HoSoDangKiKinhDoanh
-- CS001 đủ 4 loại → DANG_HOAT_DONG
-- CS002 đủ 4 loại nhưng có giấy hết hạn → CANH_CAO_VI_PHAM
-- CS003 chỉ có 2 loại → THIEU_HO_SO / DANG_DOI_PHE_DUYET
