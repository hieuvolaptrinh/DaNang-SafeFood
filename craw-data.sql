BEGIN; -- Bắt đầu giao dịch để đảm bảo tính toàn vẹn

-- [0] Xóa dữ liệu cũ (Dọn dẹp để tránh trùng lặp PK nếu bạn chạy lại nhiều lần)
-- CASCADE sẽ tự động xóa các bảng liên quan theo đúng thứ tự
TRUNCATE TABLE co_so_loai_hinh, co_so_kinh_doanh, loai_hinh_kinh_doanh, 
...
('CS004', 'Nhà hàng Sông Hàn – CN1', 'GP-2023-004', 'CS001', '2025-12-31', 'ND006', 'PX004'),
('CS005', 'Bánh mỳ Đà Nẵng Express', 'GP-2023-005', NULL, '2026-01-20', 'ND006', 'PX005');
...
INSERT INTO file_dinh_kem (maFile, urlFile, loaiFile, thoiGianGui, maMinhChung, maPhanAnh, maKhieuNai, maThongBao, maHoSoDangKiKinhDoanh, maTinhTrangKhacPhuc) VALUES
    ('FD001', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrUKPcm7to2GV5DVWnkHgfwiZQPT2A3f3xZw&s', N'image/jpeg', '2025-04-20 08:05:00', 'MC001', NULL, NULL, NULL, NULL, 'HT001'),
    ('FD002', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrUKPcm7to2GV5DVWnkHgfwiZQPT2A3f3xZw&s', N'image/png', '2025-05-25 10:35:00', 'MC002', NULL, NULL, NULL, NULL, 'HT002'),
    ('FD003', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrUKPcm7to2GV5DVWnkHgfwiZQPT2A3f3xZw&s', N'application/pdf', '2025-05-25 14:00:00', NULL, 'PA001', NULL, NULL, NULL, NULL),
    ('FD004', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrUKPcm7to2GV5DVWnkHgfwiZQPT2A3f3xZw&s', N'application/pdf', '2025-05-28 09:10:00', NULL, NULL, 'KN001', NULL, NULL, NULL),
    ('FD005', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrUKPcm7to2GV5DVWnkHgfwiZQPT2A3f3xZw&s', N'application/pdf', '2022-01-10 10:00:00', NULL, NULL, NULL, NULL, 'HSD001', NULL);
